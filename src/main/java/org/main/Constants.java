...
public class Constants {
    ...
    public final static String CLEAR_LOCATION = "//button[@aria-label='Clear location input']";
    public final static String BUTTON_FIND_JOBS = "//button[contains(text(), 'Find jobs')]";
    public final static String LIST_JOB_LINK = "//div[@id='mosaic-provider-jobcards']//td[contains(@class, 'resultContent')]//a";
